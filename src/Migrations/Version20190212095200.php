 ...
 */
final class Version20190212095200 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bibliotheque (id INT AUTO_INCREMENT NOT NULL, rue VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, code_postal INT NOT NULL, numero_rue INT NOT NULL, numero_tel INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, emprunteur_id INT DEFAULT NULL, category_id INT NOT NULL, bibliotheque_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, auteur VARCHAR(255) NOT NULL, resume LONGTEXT NOT NULL, date_parution DATETIME NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_AC634F99F0840037 (emprunteur_id), INDEX IDX_AC634F9912469DE2 (category_id), INDEX IDX_AC634F994419DE7D (bibliotheque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
